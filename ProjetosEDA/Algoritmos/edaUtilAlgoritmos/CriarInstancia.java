	...
	public static void criar(){
		try {
			...
			for (int tamanho : tamanhoInstancias) {					
				...
				FileWriter arq = new FileWriter(EDAConstants.grafosAlgoritmos + "tarefa" + tamanho + ".txt");
				...
				arq = new FileWriter(EDAConstants.grafosAlgoritmos + "operacoesI_" + tamanho + ".txt");
				...
				arq = new FileWriter(EDAConstants.grafosAlgoritmos + "operacoesR_" + tamanho + ".txt");
				gravarArq = new PrintWriter(arq);					
				...
				qtdOperacoes = tamanho*qtd;
				arq = new FileWriter(EDAConstants.grafosAlgoritmos + "operacoesA_" + tamanho + ".txt");
				gravarArq = new PrintWriter(arq);					
				listaPrioridade = new HeapMaximo(qtd*prioridadesIniciais.size());
				listaPrioridade.construir(prioridadesIniciais);	
				numeros = new ArrayList<Integer>();
				...
				qtdOperacoes = tamanho*qtd;
				arq = new FileWriter(EDAConstants.grafosAlgoritmos + "operacoesS_" + tamanho + ".txt");
				gravarArq = new PrintWriter(arq);					
				listaPrioridade = new HeapMaximo(qtd*prioridadesIniciais.size());
				listaPrioridade.construir(prioridadesIniciais);	
				numeros = new ArrayList<Integer>();
